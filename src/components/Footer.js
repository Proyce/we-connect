          ...
          <section className="container-fluid text-justify">
            <section className="row text-justify ">
              <section className="col-lg-2 col-md-4 ml-4">
                <Link to="/" className="footer-brand">WEKONNET</Link>
                <br />
                <br />
                <p className="mt-2">
              ...
              <section
                className=" footer-center col-lg-3 col-md-4 mb-4 ml-4 mt-2 text-justify"
              >
            ...
            <p className=" text-center font-weight-bold">
              WEKONNET Technologies &copy; 2020
            </p>
          </section>
        </section>
      </>
